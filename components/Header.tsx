      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-slate-100 text-sm font-semibold tracking-tight flex items-center gap-2">
            {t.header}
            <span className="text-slate-600 font-mono text-[9px] font-normal px-1.5 py-0.5 bg-white/5 rounded border border-white/5 uppercase tracking-wider">v4.2.0-stable</span>
          </h1>
        </div>
      </div>
